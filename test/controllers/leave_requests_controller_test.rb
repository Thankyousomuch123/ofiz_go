...
class LeaveRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leave_request" do
    assert_difference("LeaveRequest.count") do
      post leave_requests_url, params: { leave_request: { employee_id: @leave_request.employee_id, end_date: @leave_request.end_date, leave_id: @leave_request.leave_id, start_date: @leave_request.start_date } }
    end
  ...
  test "should update leave_request" do
    patch leave_request_url(@leave_request), params: { leave_request: { employee_id: @leave_request.employee_id, end_date: @leave_request.end_date, leave_id: @leave_request.leave_id, start_date: @leave_request.start_date } }
